        ...
        <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 md:p-8">
                <form className="space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Nome Completo do Paciente</label>
                        <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-red-500" placeholder="Digite o nome completo" />
                    </div>
            </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                    {[
                        ...
                        <button
                            ...
                            className={`p-3 rounded-lg border-2 flex flex-col items-center justify-center transition-all ${selectedRisk === risk.id
