                ...
                {cases.map(tc => (
                    <div key={tc.id} className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow flex flex-col h-full group">
                        ...
                        <div className="grid grid-cols-2 gap-3 mt-auto mb-3">
                            <button className="py-2 border border-gray-200 rounded text-gray-600 hover:bg-gray-50 text-sm font-medium">
                                Prontuário
                            </button>
                            <button className="py-2 bg-teal-50 text-teal-700 border border-teal-100 rounded hover:bg-teal-100 text-sm font-bold">
                                Lançar TDO
                            </button>
                        </div>
